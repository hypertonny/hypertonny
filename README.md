...
## 🧠 About Me
- ☁️ Cloud Engineer focused on building **scalable**, **secure**, and **resilient** infrastructures.
- 🛠️ Experienced with **AWS**, **Azure**, and **GCP** cloud platforms.
- 🧩 Passionate about **networking**, **automation scripting**, and **cyber security fundamentals**.
- 🧠 Love blending **system design** with **hacker thinking**.
- 🕶️ Staying behind the code, letting work speak.
...
- Penetration Testing Basics (because security matters)
